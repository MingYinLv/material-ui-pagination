...
var PageButton = _wrapComponent('PageButton')(function (_React$Component) {
    ...
    _createClass(PageButton, [{
        ...
        value: function render() {
            ...
            var pageClick = _props.pageClick;
            var pageNo = _props.pageNo;

            return _react3.default.createElement(_materialUi.FlatButton, { style: style, label: pageNo, onClick: function onClick() {
                    pageClick(pageNo);
                } });
        }
    }]);
